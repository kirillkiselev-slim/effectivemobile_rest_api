...
Revision ID: 49e15e8094b1
Revises: 
Create Date: 2024-09-28 15:15:35.427356
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('amount_left >= 0', name='check_amount'),
    ...
    sa.Column('amount_of_products', sa.Integer(), nullable=False),
